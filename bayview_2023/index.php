...
<body id="body">
	...
	<div id="mySidebar" class="sidebar">
		...
		<a href="register.php"><i class="fas fa-bed"></i><span>  Book a Room</span></i></a>
		</ul>
	</div>
	...
	<div class="content" id="Content">
		...
		<div id = "school_pic">
			...
			<div id="form_btn">
				<button id="log_in" type="submit" onclick="window.location.replace('login.php')">Log In</button>
				<button id="sign_up" type="submit"  onclick="window.location.replace('register.php')">Sign Up</button>
			</div>			
		</div>
