                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                                $sql=$db->query("SELECT *,DATE(created_at) AS date FROM  laboratory"); 
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?=$row['date']?></td>
                                                    <td><a href="his_doc_view_single_lab_record.php?lab_id=<?=MD5($row['sn'])?>" class="badge badge-success"><i class="mdi mdi-eye"></i> View Lab Report</a></td>
                                                </tr>
                                                </tbody>
                                            <?php   }?>
                                            <tfoot>
