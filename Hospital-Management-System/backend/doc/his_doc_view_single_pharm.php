                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">#<?=$row['pharm_bcode']?> - <?=$row['pharm_name']?></h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Pharmaceutical Name : <?=$row['pharm_name']?></h2>
                                                    <hr>
                                                    <h4 class="text-danger">Pharmaceutical Vendor : <?=$pro->sqLx('vendors','sn',$row['pharm_vendor'],'v_name')?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Pharmaceutical Quantity : <?=$row['quantity']?> Cartons</h4>
                                                    <hr>
                                                    <h4 class="text-danger">Pharmaceutical Description</h4>

                                                    <p class="text-muted mb-4">
                                                        <?=htmlspecialchars_decode($row['pharm_description'])?>
                                                    </p>
                                                   <!--
