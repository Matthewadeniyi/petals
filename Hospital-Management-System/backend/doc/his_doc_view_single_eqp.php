...
<?php include ('assets/inc/head.php');?>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <!-- ============================================================== -->
            <?php
                $eqpCode=$_GET['eqp_code'];
                $sql=$db->query("SELECT  * FROM equipments WHERE MD5(eqp_code) = '$eqpCode' ");
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Equipment #<?=$row['eqp_code']?> Details</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Equipment Name : <?=$row['eqp_name']?></h2>
                                                    <hr>
                                                    <h4 class="text-danger">Equipment Vendor: <?=$row['eqp_vendor']?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Equipment Barcode: <?=$row['eqp_code']?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Equipment(s) Available : <?=$row['quantity']?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Equipment Status : <?=$row['status']?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Equipment Description</h4>
                                                    <p class="text-muted mb-4">
                                                        <?=htmlspecialchars_decode($row['eqp_description'])?>
                                                    </p>
                                                   <!--
