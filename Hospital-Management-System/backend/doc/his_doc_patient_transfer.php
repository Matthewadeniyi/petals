                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                                $sql=$db->query("SELECT * FROM  patients WHERE type = '1' "); 
                                            ...
                                            ?>
                                                ...
                                                <td><?=$i++;?></td>
                                                    ...
                                                    <td>
                                                        <a href="his_doc_transfer_single_patient.php?patient_id=<?=MD5($row['patientno'])?>" class="badge badge-primary"><i class="mdi mdi-check-box-outline "></i> Transfer Patient</a>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            <?php  }?>
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                                $sql=$db->query("SELECT * FROM  patients_transfers "); 
