                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       <!-- <a href="his_admin_manage_patient.php?delete=<?php echo $row->pat_id;?>" class="badge badge-danger"><i class=" mdi mdi-trash-can-outline "></i> Delete</a>-->
                                                        <a href="his_doc_view_single_patient.php?patient_id=<?=mD5($row['patientno'])?>" class="badge badge-success"><i class="mdi mdi-eye"></i> View</a>
                                                        <a href="his_doc_update_single_patient.php?patient_id=<?=mD5($row['patientno'])?>" class="badge badge-primary"><i class="mdi mdi-check-box-outline "></i> Update</a>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            <?php   }?>
