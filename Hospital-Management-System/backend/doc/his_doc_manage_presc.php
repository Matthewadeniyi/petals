<?php
  ...
  if(isset($_GET['DeletePrescId'])){
    $prescId = $_GET['DeletePrescId'];
    $sql = $pro->delete('prescriptions','MD5(id)',$prescId);
    if($sql)
    {
      $success = "Prescription Records Deleted";
      header('Location:his_doc_manage_presc.php');
      exit;
    }
      else
      {
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone">Date Recorded</th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <td><?=$i++?></td>
                                                    ...
                                                    <td><?=$rows['date']?></td>
                                                    <td>
                                                        <a href="his_doc_view_single_pres.php?prescId=<?=MD5($rows['id'])?>" class="badge badge-success"><i class="fas fa-eye"></i> View</a>
                                                        <a href="his_doc_upate_single_pres.php?prescId=<?=MD5($rows['id'])?>" class="badge badge-warning"><i class="fas fa-eye-dropper "></i> Update</a>
                                                        <a href="his_doc_manage_presc.php?DeletePrescId=<?=MD5($rows['id'])?>" class="badge badge-danger"><i class=" fas fa-trash-alt "></i> Delete</a>
