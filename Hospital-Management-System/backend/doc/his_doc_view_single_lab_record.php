    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php
                ...
                $labId=$_GET['lab_id'];
                $sql=$db->query("SELECT  *,DATE(created_at) AS date  FROM laboratory WHERE MD5(sn) ='$labId'");
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">#<?=MD5($row['sn'])?></h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Patient's Name : <?=$row['patient_name']?></h2>
                                                    <hr>
                                                    <h3 class="text-danger ">Patient Number : <?=$row['patientno']?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Patient Ailment : <?=$pro->sqLx('patients','patientno',$row['patientno'],'ailment')?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Date Recorded : <?=$row['date']?></h3>
                                                    <hr>
                                                    <?php
                                                        $patientId = $row['patientno'];
                                                        $sql = $db->query("SELECT *,DATE(created_at) AS date  FROM laboratory WHERE patientno='$patientId'");
                                                        $i=1;
                                                    ...
                                                    <p class="text-muted mb-4">
                                                        <?=$innerRow['date']?>
                                                        <?=htmlspecialchars_decode($innerRow['lab_test'])?>
                                                    </p>
                                                    <hr>
                                                    <h2 class="align-centre">Laboratory Result</h2>
                                                    <p class="text-muted mb-4">
                                                        <?=$innerRow['date']?>
                                                        <?=htmlspecialchars_decode($innerRow['lab_result'])?>
                                                    </p>
                                                    <hr>
                                                    <?php $i++; }?>
                                                   <!--
