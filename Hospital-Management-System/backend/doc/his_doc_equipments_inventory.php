                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                                $sql=$db->query("SELECT * FROM  equipments "); 
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?=$row['eqp_department']?></td>
                                                    <td><?=$row['quantity']?></td>
                                                    <td>
                                                        <a href="his_doc_view_single_eqp.php?eqp_code=<?=MD5($row['eqp_code'])?>" class="badge badge-success"><i class="far fa-eye "></i> View</a>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            <?php }?>
