    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php
                ...
                $sql=$db->query("SELECT  * FROM pharmaceutical_categories WHERE MD5(sn) = '$pharmId'");
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Pharmaceutical Name: <?=$row['p_name']?></h2>
                                                    <hr>
                                                    <h6 class="text-danger">Phrmaceutical Vendor:  <?=$pro->sqLx('vendors','sn',$row['p_vendor'],'v_name')?></h6>
                                                    <hr>
                                                    <p class="text-muted mb-4">
                                                        <?=htmlspecialchars_decode($row['p_description'])?>
                                                    </p>
                                                   <!--
