                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup"><?=$pro->total1('patients')?></span></h3>
                                        ...
                                        <table class="table table-borderless table-hover table-centered m-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?=$pro->sqLx('patients_type','sn',$row['type'],'type')?>
                                                    </td>
                                                    <td>
                                                        <?=$row['ailment']?>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="his_doc_view_single_patient.php?patient_id=<?=mD5($row['patientno'])?>" class="btn btn-xs btn-success"><i class="mdi mdi-eye"></i> View</a>
                                                    </td>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
                                                </tr>
                                            </tbody>
                                            <?php }?>
