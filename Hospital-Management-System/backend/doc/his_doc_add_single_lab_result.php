    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php
                ...
                $sql=$db->query("SELECT  * FROM laboratory WHERE sn='$labNumber'");
                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" required="required" readonly name="lab_pat_name" value="<?=$row['patient_name']?>" class="form-control" id="inputEmail4" placeholder="Patient's First Name">
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputPassword4" class="col-form-label">Patient Ailment</label>
                                                        <input required="required" type="text" readonly name="lab_pat_ailment" value="<?=$pro->sqLx('patients','patientno',$row['patientno'],'ailment')?>" class="form-control"  id="inputPassword4" placeholder="Patient`s Last Name">
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input type="text" required="required" readonly name="lab_pat_number" value="<?=$row['patientno']?>" class="form-control" id="inputEmail4" placeholder="DD/MM/YYYY">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <textarea required="required"  type="text" class="form-control" name="labtest" id="editor"><?=htmlspecialchars_decode($row['lab_test'])?></textarea>
                                                </div>
