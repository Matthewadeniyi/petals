                            ...
                            <div class="card-body p-4">
                                ...
                                <form method='POST' >
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" name="docnumber" type="text" id="emailaddress" required="" placeholder="Enter your doctor number">
                                    </div>
                                    ...
                                    <div class="form-group mb-0 text-center">
                                        <button class="btn btn-success btn-block" name="doctorLogin" type="submit"> Log In </button>
                                    </div>
