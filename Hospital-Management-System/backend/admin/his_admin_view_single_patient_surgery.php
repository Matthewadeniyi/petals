    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php
                ...
                {
                    $mysqlDateTime = $row['created_at'] //trim timestamp to dd/mm/yyyy formart
            ?>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">#<?=$row['s_number']?></h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                ...
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Patient's Name : <?=$pro->SqLx('patients','patientno',$row['patientno'],'firstname')?> <?=$pro->SqLx('patients','patientno',$row['patientno'],'lastname')?></h2>
                                                    <hr>
                                                    <h3 class="align-centre ">Patient Number : <?=$row['patientno']?></h3>
                                                    <hr>
                                                    <h3 class="align-centre ">Patient Ailment : <?=$pro->SqLx('patients','patientno',$row['patientno'],'ailment')?></h3>
                                                    <hr>
                                                    <h3 class="align-centre ">Date Surgery Conducted : <?php echo date("d/m/Y", strtotime($mysqlDateTime));?></h3>
                                                    <hr>
                                                    <h2 class="align-centre">Surgeon :  <?=$pro->sqLx('employee','sn',$row['doctor'],'firstname')?> <?=$pro->sqLx('employee','sn',$row['doctor'],'lastname')?> </h2>
                                                    <hr>
                                                    <h2 class="align-centre">Surgery Status : <span class ="btn btn-success"> <?php echo $row['status'];?></span> </h2>
                                                    <hr>
