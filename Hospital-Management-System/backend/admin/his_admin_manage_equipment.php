<?php
 ...
 include('assets/inc/config.php');
  ...
  if(isset($_GET['delete']))
  {
        ...
        header('location:his_admin_manage_equipment.php');
        exit;
        }
        else
        {
                                        ...
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tbody>
                                                    <?php
                                                        ...
                                                        $sql=$db->query("SELECT * FROM  equipments WHERE eqp_department = 'Surgical | theatre' "); 
                                                        $i=1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="his_admin_manage_equipment.php?delete=<?=$row['sn']?>" class="badge badge-danger"><i class="fas fa-trash-alt "></i> Delete</a>
