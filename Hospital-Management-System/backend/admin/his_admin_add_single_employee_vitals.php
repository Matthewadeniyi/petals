                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input required="required" type="text" readonly name="" value="<?=$pro->sqLx('departments','sn',$row['department'],'departments')?>" class="form-control"  id="inputPassword4" placeholder="Patient`s Last Name">
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input type="text" required="required" readonly name="id" value="<?=$row['employeeno']?>" class="form-control" id="inputEmail4" placeholder="DD/MM/YYYY">
                                                    </div>
