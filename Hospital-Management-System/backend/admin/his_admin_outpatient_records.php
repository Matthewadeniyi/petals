                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                                $sql=$db->query("SELECT * FROM patients WHERE type = '2' "); 
                                                ...
                                                <td><?=$i++?></td>
                                                    ...
                                                    <td><?=$rows['address']?></td>
                                                    <td><?=$rows['phoneno']?></td>
                                                    <td><?=$rows['age']?> Years</td>
                                                    
                                                    <td><a href="his_admin_view_single_patient.php?patient_no=<?=$rows['patientno']?>" class="badge badge-success"><i class="mdi mdi-eye"></i> View</a></td>
                                                </tr>
                                                </tbody>
                                            <?php }?>
                                            <tfoot>
