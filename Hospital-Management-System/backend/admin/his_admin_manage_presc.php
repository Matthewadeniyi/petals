<?php
 ...
 include('assets/inc/config.php');
  //$prescriptionId= MD5($rows['patientno']);

  if(isset($_GET['delete'])){
    $prescriptionId= $_GET['delete'];
    if($pro->delete('prescriptions','MD5(patient_id)',$prescriptionId)){
                                ...
                                <div class="card-box">
                                    ...
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                                $sql=$db->query("SELECT * FROM  prescriptions"); 
                                                $i=1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_admin_view_single_pres.php?prescid=<?=MD5($rows['patient_id'])?>" class="badge badge-success"><i class="fas fa-highlighter "></i> View</a>
                                                        <a href="his_admin_update_single_pres.php?prescid=<?=MD5($rows['patient_id'])?>" class="badge badge-warning"><i class="fas fa-eye-dropper "></i> Update</a>
                                                        <a href="his_admin_manage_presc.php?delete=<?=MD5($rows['patient_id'])?>" class="badge badge-danger"><i class=" fas fa-trash-alt "></i> Delete</a>
