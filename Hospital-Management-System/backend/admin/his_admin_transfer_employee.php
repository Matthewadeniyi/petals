                                        ...
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            */
                                            //sql code to get to ten docs  randomly
                                                $sql=$db->query("SELECT * FROM  employee WHERE department IS NOT NULL ORDER BY RAND() "); 
                                                $i=1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="his_admin_transfer_single_employee.php?employeeno=<?=$row['employeeno']?>" class="badge badge-warning"><i class="mdi mdi-check-box-outline "></i> Transfer Employee</a>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            <?php }?>
