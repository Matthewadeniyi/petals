                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">#<?=$rows['patient_id']?></h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Name : <?=$pro->sqLx('patients','patientno',$rows['patient_id'],'firstname')?> <?=$pro->sqLx('patients','patientno',$rows['patient_id'],'lastname')?></h2>
                                                    <hr>
                                                    <h3 class="text-danger">Age : <?=$pro->sqLx('patients','patientno',$rows['patient_id'],'age')?> Years</h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Patient Number : <?=$pro->sqLx('patients','patientno',$rows['patient_id'],'patientno')?></h3>
                                                    <hr>
                                                    <?php $patientType = $pro->sqLx('patients','patientno',$rows['patient_id'],'type');?>
                                                    <h3 class="text-danger ">Patient Category : <?= 
                                                    $patientCategory= $pro->sqLx('patients_type', 'sn', $patientType, 'type');
                                                    ?></h3>
                                                    <hr>
                                                    <h3 class="text-danger ">Patient Ailment : <?=$pro->sqLx('patients','patientno',$rows['patient_id'],'ailment')?></h3>
                                                    <hr>
