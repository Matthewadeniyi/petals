                                        ...
                                        <table id="demo-foo-filtering" class="table table-bordered table-hover toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="his_admin_transfer_single_patient.php?patient_no=<?=$rows['patientno']?>" class="badge badge-primary"><i class="mdi mdi-check-box-outline "></i> Transfer Patient</a>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            <?php }?>
