<?php	
    ...
    $adminId = $_SESSION['id'];
    $sql = $db->query("SELECT * FROM users WHERE sn='$adminId'");
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-xl-4">
                                    <div class="card-box text-center">
                                        <img src="assets/images/users/doc-dpic" class="rounded-circle avatar-lg img-thumbnail"
                                            alt="profile-image">

                                        <h4 class="mb-0"><?=$row['firstname']?> <?=$row['lastname']?></h4>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" name="email" class="form-control" id="useremail" value="<?=$row['email']?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="useremail">Profile Picture</label>
                                                                <input type="file" name="picture" class="form-control btn btn-success" id="useremail" value="">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="text-right">
                                                        <button type="submit" name="updateAdminProfile" class="btn btn-success waves-effect waves-light mt-2"><i class="mdi mdi-content-save"></i> Save</button>
                                                    </div>
                                                </form>
                                            ...
                                            <div class="tab-pane" id="settings">
                                                <form method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type='password' name="confpassword" class="form-control" id="useremail" placeholder="Confirm New Password">
                                                    </div>
