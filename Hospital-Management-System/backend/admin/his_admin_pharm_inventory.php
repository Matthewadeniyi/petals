                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tbody>
                                                <?php
                                                /*
                                                    *get details of all pharmaceuticals
                                                    *
                                                */
                                                ...
                                                <tr>
                                                    <td><?=$i++?></td>
                                                    <td><?=$rows['pharm_name']?></td>
                                                    <td><?=$rows['pharm_bcode']?></td>
                                                    <td><?=$pro->sqLx('vendors','sn',$rows['pharm_vendor'],'v_name')?></td>
                                                    <td><?=$pro->sqlx('pharmaceutical_categories','sn',$rows['pharm_category'],'p_name')?></td>
                                                    <td><?=$rows['quantity']?> Cartons</td>

                                                    <td><a href="his_admin_view_single_pharm.php?pharmid=<?=MD5($rows['pharm_bcode'])?>" class="badge badge-success"><i class="far fa-eye "></i> View</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  } ?>
                                            <tfoot>
