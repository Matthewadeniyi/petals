                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup"><?=$pro->total('patients','type',2); ?></span></h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup"><?=$pro->total('patients','type',1); ?></span></h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup"><?=$pro->total1('employee')?></span></h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup"><?=$pro->total1('vendors')?></span></h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup"><?=$pro->total1('equipments')?></span></h3>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup"><?=$pro->total1('Pharmaceuticals')?></span></h3>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless table-hover table-centered m-0" data-page-size="7">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="width: 36px;">
                                                        <img src="../doc/assets/images/users/doc-icon.png" alt="img" title="contact-img" class="rounded-circle avatar-sm" />
                                                    </td>
                                                    <td></td>
                                                    ...
                                                    <td><?=$pro->SqLx('departments','sn',$rows['department'],'departments','Empty')?></td>
                                                    
                                                    <td>
                                                        <a href="his_admin_view_single_employee.php?docid=<?=$rows['employeeno']?>" class="btn btn-xs btn-primary"><i class="mdi mdi-eye"></i> View</a>
                                                    </td>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
                                                </tr>
                                            </tbody>
                                            <?php }?>
