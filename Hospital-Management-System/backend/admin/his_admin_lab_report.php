                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                                $sql=$db->query("SELECT * FROM  laboratory  "); 
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= date("d/m/Y", strtotime($mysqlDateTime));?></td>
                                                    <td><a href="his_admin_view_single_lab_record.php?lab_id=<?=$row['sn']?>" class="badge badge-success"><i class="mdi mdi-eye"></i> View Lab Report</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  }?>
                                            <tfoot>
