                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Account Number :  <?=$rows['account_number']?></h2>
                                                    <hr>
                                                    <h4 class="text-danger"> Account Name : <?=$rows['account_name']?></h6>
                                                    <hr>
                                                    <h4 class="text-danger">Account Amount : $ <?=$rows['amount']?> </h6>
                                                    <hr>
                                                    <h4 class="align-centre">Account Description</h6>
                                                    <hr>
                                                    <p class="text-muted mb-4">
                                                        <?=htmlspecialchars_decode($rows['description'])?>
                                                    </p>
                                                   <!--
