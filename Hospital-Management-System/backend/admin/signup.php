                            ...
                            <div class="card-body p-4">
                                ...
                                <form  method='post'>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text"  name ="firstname" id="fullname" placeholder="Enter your name" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="fullname">Last Name</label>
                                        <input class="form-control" type="text" name="lastname" id="fullname" placeholder="Enter your name" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group mb-0 text-center">
                                        <button class="btn btn-primary btn-block" name="adminsignup" type="submit"> Sign Up </button>
                                    </div>
